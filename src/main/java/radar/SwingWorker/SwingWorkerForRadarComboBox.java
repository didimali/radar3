...
public class SwingWorkerForRadarComboBox extends SwingWorker<Object[],Void>{
	...
	public SwingWorkerForRadarComboBox(RadarCombox box,String className,String methodName) {		
		this.box = box;
