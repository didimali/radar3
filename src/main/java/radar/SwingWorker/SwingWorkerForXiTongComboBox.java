...
public class SwingWorkerForXiTongComboBox extends  SwingWorker<Object[],Void>{
	private XiTongComBox box;
	...
	public SwingWorkerForXiTongComboBox(XiTongComBox box,String className,String methodName) {		
		this.box = box;
